...
public class UntitledTestCase {
  ...
  public void testUntitledTestCase() throws Exception {
    ...
    driver.findElement(By.name("name")).sendKeys("Rosy");
    driver.findElement(By.name("email")).click();
    driver.findElement(By.name("email")).clear();
    driver.findElement(By.name("email")).sendKeys("rosy@gmail.com");
    ...
    assertTrue(driver.findElement(By.cssSelector("BODY")).getText().matches("^[\\s\\S]*Rosy[\\s\\S]*$"));
  }
